                ...
                <div class="relative group">
                    <button type="button"
                        ...
                        <img src="{{ asset('iconos/destinos-nacionales.svg') }}"
                            class="w-6 h-6 sm:w-7 sm:h-7 {{ request()->has('destino') ? 'opacity-100 scale-110 drop-shadow-sm' : 'opacity-70 group-hover:opacity-100 group-hover:scale-110' }} transition-all duration-300 object-contain"
                    ...
                    <div
                        ...
                        @empty
                            <span class="px-5 py-2 text-xs text-slate-500 italic">No hay destinos</span>
                        @endforelse
                    </div>
                </div>

                <a href="{{ route('hoteles.catalogo') }}"
                    class="group flex flex-col items-center justify-center gap-1.5 focus:outline-none px-2 {{ request()->routeIs('hoteles.catalogo') && !request()->has('categoria') && !request()->has('destino') ? '' : '' }}">
                    <img src="{{ asset('iconos/movilidades.svg') }}"
                        class="w-6 h-6 sm:w-7 sm:h-7 {{ request()->routeIs('hoteles.catalogo') && !request()->has('categoria') && !request()->has('destino') ? 'opacity-100 scale-110 drop-shadow-sm' : 'opacity-70 group-hover:opacity-100 group-hover:scale-110' }} transition-all duration-300 object-contain"
                        alt="Hoteles">
                    <span
                        class="text-[0.625rem] md:text-[0.7rem] lg:text-[0.8rem] font-bold tracking-wide transition-all text-brand-blue capitalize">Hoteles</span>
                </a>

                <a href="{{ route('hoteles.catalogo', ['categoria' => '5 Estrellas']) }}"
                    class="group flex flex-col items-center justify-center gap-1.5 focus:outline-none px-2">
                    <img src="{{ asset('iconos/viajes-escolares.svg') }}"
                        class="w-6 h-6 sm:w-7 sm:h-7 {{ request('categoria') === '5 Estrellas' ? 'opacity-100 scale-110 drop-shadow-sm' : 'opacity-70 group-hover:opacity-100 group-hover:scale-110' }} transition-all duration-300 object-contain"
